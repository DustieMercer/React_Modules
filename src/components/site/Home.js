            ...
            <div className='mainDiv'>
             ...
             <hr />
                ...
                <ul>
                    ...
                    <li>This app simply scratches th esusrface on what is possible with React.</li>
                    <li>We have tried to collect the very best resources for this app, and we have cited those <Link to='/resources'>here</Link></li>
                    <li>This set up for this app might be the most confusing part. Hang in there.</li>
